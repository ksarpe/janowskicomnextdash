(function () {
  ...
  // Dynamiczne pobieranie adresu bazowego, skąd skrypt został załadowany (działa na localhost i na Vercel)
  const serverOrigin = new URL(scriptTag.src).origin;

  // --- IFRAME Z OKNEM CZATU ---
  const iframe = document.createElement("iframe");
  iframe.src = `${serverOrigin}/embed/chat?clientId=${clientId}`;
